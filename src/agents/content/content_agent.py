...
class ContentAgent(BaseAgent):
    ...
    async def process(self, input_data: Dict[str, Any]) -> AgentResult:
        ...
        try:
            ...
            executive_summary = await self._create_executive_summary(
                topic, research_findings, analysis_results
            )
            main_content = await self._create_main_content(
                topic, research_findings, analysis_results
            )
            ...
            result = AgentResult(
                ...
                metadata={
                    ...
                    "recommendations_count": len(
                        recommendations_section.get("recommendations", [])
                    ),
                },
    ...
    async def _create_executive_summary(
        self, topic: str, research_findings: Dict[str, Any], analysis_results: Dict[str, Any]
    ) -> Dict[str, Any]:
    ...
    async def _create_main_content(
        self, topic: str, research_findings: Dict[str, Any], analysis_results: Dict[str, Any]
    ) -> List[Dict[str, Any]]:
            ...
            "subsections": [
                {
                    "title": "Key Findings",
                    "content": "\n".join(
                        [f"• {finding}" for finding in research_findings.get("main_findings", [])]
                    ),
                },
                {
                    "title": "Current Trends",
                    "content": "\n".join(
                        [f"• {trend}" for trend in research_findings.get("current_trends", [])]
                    ),
                },
            ],
        }
            ...
            "subsections": [
                {
                    ...
                    "content": "\n".join(
                        [
                            f"• {insight}"
                            for insight in analysis_results.get("synthesis", {}).get(
                                "key_insights", []
                            )
                        ]
                    ),
                },
                {
                    ...
                    "content": "\n".join(
                        [
                            f"• {implication}"
                            for implication in analysis_results.get("synthesis", {}).get(
    ...
    def _generate_content_metadata(
        self, content: Dict[str, Any], topic: str, content_type: str
    ) -> Dict[str, Any]:
        ...
        return {
            ...
            "quality_indicators": {
                ...
                "actionable": len(content.get("recommendations", {}).get("recommendations", []))
                > 0,
            },
        }
