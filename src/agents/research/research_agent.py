...
class ResearchAgent(BaseAgent):
    ...
    async def _generate_search_queries(self, topic: str, focus_areas: List[str]) -> List[str]:
        ...
        messages = [
            SystemMessage(content="You are a research expert who creates effective search queries."),
    ...
    async def _synthesize_findings(self, content: Dict[str, Any], topic: str) -> Dict[str, Any]:
        ...
        messages = [
            SystemMessage(content="You are a research analyst who synthesizes information from multiple sources."),
            HumanMessage(content=prompt)
        ]
